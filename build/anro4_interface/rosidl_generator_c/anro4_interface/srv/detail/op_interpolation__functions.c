...
anro4_interface__srv__OpInterpolation_Request__init(anro4_interface__srv__OpInterpolation_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->method)) {
    anro4_interface__srv__OpInterpolation_Request__fini(msg);
    return false;
  }
  // version
...
{
  anro4_interface__srv__OpInterpolation_Request * msg = (anro4_interface__srv__OpInterpolation_Request *)malloc(sizeof(anro4_interface__srv__OpInterpolation_Request));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(anro4_interface__srv__OpInterpolation_Request));
  bool success = anro4_interface__srv__OpInterpolation_Request__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
anro4_interface__srv__OpInterpolation_Request__Sequence__init(anro4_interface__srv__OpInterpolation_Request__Sequence * array, size_t size)
{
  ...
  anro4_interface__srv__OpInterpolation_Request * data = NULL;
  if (size) {
    data = (anro4_interface__srv__OpInterpolation_Request *)calloc(size, sizeof(anro4_interface__srv__OpInterpolation_Request));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = anro4_interface__srv__OpInterpolation_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        anro4_interface__srv__OpInterpolation_Request__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
anro4_interface__srv__OpInterpolation_Request__Sequence__fini(anro4_interface__srv__OpInterpolation_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      anro4_interface__srv__OpInterpolation_Request__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  anro4_interface__srv__OpInterpolation_Request__Sequence * array = (anro4_interface__srv__OpInterpolation_Request__Sequence *)malloc(sizeof(anro4_interface__srv__OpInterpolation_Request__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = anro4_interface__srv__OpInterpolation_Request__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    anro4_interface__srv__OpInterpolation_Request__Sequence__fini(array);
  }
  free(array);
}
...
anro4_interface__srv__OpInterpolation_Response__init(anro4_interface__srv__OpInterpolation_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->server_feedback)) {
    anro4_interface__srv__OpInterpolation_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  anro4_interface__srv__OpInterpolation_Response * msg = (anro4_interface__srv__OpInterpolation_Response *)malloc(sizeof(anro4_interface__srv__OpInterpolation_Response));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(anro4_interface__srv__OpInterpolation_Response));
  bool success = anro4_interface__srv__OpInterpolation_Response__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
anro4_interface__srv__OpInterpolation_Response__Sequence__init(anro4_interface__srv__OpInterpolation_Response__Sequence * array, size_t size)
{
  ...
  anro4_interface__srv__OpInterpolation_Response * data = NULL;
  if (size) {
    data = (anro4_interface__srv__OpInterpolation_Response *)calloc(size, sizeof(anro4_interface__srv__OpInterpolation_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = anro4_interface__srv__OpInterpolation_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        anro4_interface__srv__OpInterpolation_Response__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
anro4_interface__srv__OpInterpolation_Response__Sequence__fini(anro4_interface__srv__OpInterpolation_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      anro4_interface__srv__OpInterpolation_Response__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  anro4_interface__srv__OpInterpolation_Response__Sequence * array = (anro4_interface__srv__OpInterpolation_Response__Sequence *)malloc(sizeof(anro4_interface__srv__OpInterpolation_Response__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = anro4_interface__srv__OpInterpolation_Response__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    anro4_interface__srv__OpInterpolation_Response__Sequence__fini(array);
  }
  free(array);
}
