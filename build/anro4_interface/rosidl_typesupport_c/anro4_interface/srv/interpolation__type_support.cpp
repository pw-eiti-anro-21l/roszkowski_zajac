...
static const _Interpolation_Request_type_support_symbol_names_t _Interpolation_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anro4_interface, srv, Interpolation_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, anro4_interface, srv, Interpolation_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, anro4_interface, srv, Interpolation_Request)() {
  return &::anro4_interface::srv::rosidl_typesupport_c::Interpolation_Request_message_type_support_handle;
}
...
static const _Interpolation_Response_type_support_symbol_names_t _Interpolation_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anro4_interface, srv, Interpolation_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, anro4_interface, srv, Interpolation_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_anro4_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, anro4_interface, srv, Interpolation_Response)() {
  return &::anro4_interface::srv::rosidl_typesupport_c::Interpolation_Response_message_type_support_handle;
}
...
static const _Interpolation_type_support_symbol_names_t _Interpolation_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anro4_interface, srv, Interpolation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, anro4_interface, srv, Interpolation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, anro4_interface, srv, Interpolation)() {
  return &::anro4_interface::srv::rosidl_typesupport_c::Interpolation_service_type_support_handle;
}
